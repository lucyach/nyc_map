...
locations = [
    ...
    ("Lower East Side for DJs", 40.71847031817319, -73.98782878404761, "club/bar", "Neighborhood with DJ venues; Tejan rec"),
    ...
    ("Fushimi Market", 40.74690639442177, -73.98977995779416, "store", "Market near Strand; Tejan rec"),
